...
from Design_Curve_fitting import Ui_MainWindow, MplCanvas
...
# ---- convert mpl figure to QPixmap ----
    ...
    def error_mapping(self):
        ...
        if (self.ui.xaxis_comboBox.currentIndex() == 0 and self.ui.yaxis_comboBox.currentIndex() == 0):  
            ...
            step = int(100/(self.ui.spinBox_mappoly.value() *
                       self.ui.spinBox_mapoverlap.value()))  
            self.ui.progressBar.show()
            for j in range(self.ui.spinBox_mapoverlap.value()):  
                for i in range(self.ui.spinBox_mappoly.value()):  
        ...
        elif (self.ui.xaxis_comboBox.currentIndex() == 0 and self.ui.yaxis_comboBox.currentIndex() == 1):  
